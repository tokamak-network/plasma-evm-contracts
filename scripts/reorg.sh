...
personal.importRawKey('$PRIVATEKEY1', ""); personal.importRawKey('$PRIVATEKEY2', "");
personal.unlockAccount('$ADDRESS1', "", 0); personal.unlockAccount('$ADDRESS2', "", 0);
console.log('Data: accounts=[' + eth.accounts + ']');
